...
| <p>#!/bin/sh</p><p>#PBS -V                                                                             </p><p>#PBS -N cfx_job                                                                     # job 이름 지정</p><p>#PBS -q commercial                                                               # queue 지정</p><p>#PBS -l select=1:ncpus=40:mpiprocs=40:ompthreads=1                 # 작업 청크 단위 지정</p><p>#PBS -l walltime=04:00:00                                                       # 예상 작업 소요 시간 지정</p><p>#PBS -A ansys </p><p> </p><p>cd $PBS_O_WORKDIR</p><p> </p><p>TOTAL_CPUS=$(wc -l $PBS_NODEFILE | awk '')</p><p> </p><p> </p><p>cfx5solve -def StaticMixer.def -par-local -partition ${cpus}            # CFX 명령 실행</p> |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| <p> $ qstat &#x3C;-a, -n, -s, -H, -x, …></p><p>ex> qstatJob id Name User Time Use S Queue-------------------------------------------------------------------0001.pbcm test_01 user01 8245:43: R commercail0002.pbcm test_03 user03 7078:45: R commercail0003.pbcm test_04 user04 1983:11: Q commercail</p> |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
