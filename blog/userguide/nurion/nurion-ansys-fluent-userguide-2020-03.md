...
| <p> (set! *cx-exit-on-error* #t)<br> rc wst.cas                                     # read case file<br> /solve/init/init                               # initialize the solution<br> it 100                                          # calculate 100 iterations<br> wd wst.dat                                   # write data file<br> exit                                            # exit FLUENT<br> yes</p> |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| <p>#!/bin/sh<br>#PBS -V<br>#PBS -N fluent_job                                                          # job 이름 지정<br>#PBS -q commercial                                                       # 큐 지정<br>#PBS -l select=1:ncpus=40:mpiprocs=40:ompthreads=1         # MPI 태스크 및 Threads 수 지정<br>#PBS -l walltime=04:00:00                                               # 예상 작업 소요 시간 지정<br>#PBS -A ansys <br> <br>cd $PBS_O_WORKDIR<br> <br>cpus=`cat $PBS_NODEFILE | wc -l`<br> <br><br><br>fluent 3d -pethernet -t${cpus} -g -i wst.in > wst.output</p> |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
