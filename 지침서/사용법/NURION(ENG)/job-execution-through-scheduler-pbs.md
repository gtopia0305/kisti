...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **KNL**       | **exclusive**                                                                                                                                                                                    | Exclusive resource queue for supporting significant challenges and group research among R\&D innovative support programs                                                    |
| **normal**    | General resource queue for free service users (creative research, national strategy, and innovative support areas) and paid service users                                                        |                                                                                                                                                                             |
| **long**      | General resource queue for long-term job execution that can be used for up to 120 h (five days)                                                                                                  |                                                                                                                                                                             |
| **flat**      | General resource queue with a flat memory mode where MCDRAM (16 GB) and DDR4 can be designated and up to 102 GB of memory can be used (refer to C. How to use flat node in Miscellaneous Manual) |                                                                                                                                                                             |
| **debug**     | General resource queue applied with the shared node policy for debugging of the KNL node; can be debugged through interactive jobs                                                               |                                                                                                                                                                             |
| **SKL**       | **commercial**                                                                                                                                                                                   | General resource queue applied with the shared node policy for executing commercial applications (\* Commercial SW excluding Gaussian must use commercial queue as default) |
| **norm\_skl** | General resource queue of the SKL node                                                                                                                                                           |                                                                                                                                                                             |
...
| <pre><code>$ qstat -i -w -T -u user01</code></pre><p><img src="https://www.ksc.re.kr/file/image/?path=sos/jcs/2020/02/&#x26;name=e7KSHFnzy6a6X9h.png" alt="" data-size="original"></p> |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
