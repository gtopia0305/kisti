...
&#x20;\- 모든 큐(파티션)에서 작업 할당은 **공유 노드 정책**(하나의 노드에 복수개 작업 동시 수행 가능)이 적용된다.(22.03.17. 이후) &#x20;
...
**◦ 일반사용자가 사용할 수 있는 파티션은 다음과 같다. (2022년 3월 17일 이후)**

| <p>큐명</p><p>(CPU종류_GPU종류_GPU개수)</p> | <p>할당</p><p>노드</p><p>수</p> | <p>노드</p><p>리스트</p>       | <p>Total CPU</p><p>core 수</p> | 작업제출개수제한 \* | 리소스점유제한 \*\* | 비고     |                                        |   |
| ----------------------------------- | -------------------------- | ------------------------- | ----------------------------- | ----------- | ------------ | ------ | -------------------------------------- | - |
| <p>사용자별</p><p>최대제출작업개수</p>          | <p>사용자별</p><p>최대실행작업개수</p> | <p>작업별</p><p>최대노드점유개수</p> | <p>사용자별</p><p>최대GPU점유개수</p>   |             |              |        |                                        |   |
| cas\_v100nv\_8                      | 5                          | gpu\[01-05]               | 160                           | 2           | -            | **40** | <p>v100</p><p>(NVlink)</p><p>8ea탑재</p> |   |
| cas\_v100nv\_4                      | 4                          | gpu\[06-09]               | 160                           | 2           | -            | **16** | <p>V100</p><p>(NVlink)</p><p>4ea탑재</p> |   |
| cas\_v100\_4                        | 15                         | gpu\[10-24]               | 600                           | 4           | -            | **40** | <p>V100</p><p>4ea탑재</p>                |   |
| cas\_v100\_2                        | 3                          | gpu\[25-26,29]            | 96                            | 2           | -            | **10** | <p>V100</p><p>2ea탑재</p>                |   |
| skl                                 | 10                         | skl\[01-10]               | 360                           | 2           | 2            | 2      | -                                      |   |
| bigmem                              | 3                          | bigmem\[01-02]            | 120                           | 1           | 1            | 1      | -                                      |   |
...
**※ 노드 구성은 시스템 사용량에 따라 시스템 운영 중에 조정될 수 있음.**
